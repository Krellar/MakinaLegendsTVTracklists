...
for (var iTMP = 0; iTMP < children.length; iTMP++)
{
    ...
    if(tmpElement != null)
    {
        createTracklistAsync(tmpElement.innerText, nodeIndex);
    }
}
...
async function createTracklistAsync(sesionName, sectionIndex)
{
    ...
    if(tracklistArray.includes(sesionName))
    {
        ...
        var xpathParentNode = "/html/body/div[2]/div/div/div/div/section[" + sectionIndex + "]/div/div/div/div/div";
